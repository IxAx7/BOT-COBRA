...
client.on('message',async message => {
  ...
  if(!credits[author]) credits[author] = {credits: 100};
...
client.on('message', msg => {
  if(msg.content === 'رابط')
  msg.reply(' https://discord.gg/hfc7H9C ')
...
client.on('ready',  () => {
    console.log('تم تشغيل : ➣BOT Cobra  ');
